...
stdout: $(inputs.output_filename)_stdout.txt
stderr: $(inputs.output_filename)_stderr.txt
baseCommand: ["bash","update_cBioPortal_data_wrapper.sh"]
  ...
  InitialWorkDirRequirement:
    listing:
      - entryname: update_cBioPortal_data_wrapper.sh
        entry: |-
          update_cBioPortal_data.py $@ || touch failed.txt
