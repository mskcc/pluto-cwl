...
# -*- coding: utf-8 -*-
"""
Test case for the concat-mafs cwl
"""
import os
import sys
import unittest
...
class TestConcatMafs(PlutoTestCase):
    ...
    def test_concat_mafs1(self):
        """
        Test case for concatenating two maf files
        """
        self.maxDiff = None
        rows1 = [ self.maf_row1, self.maf_row2, self.maf_row3 ]
        ...
        rows2 = [ self.maf_row3, self.maf_row4, self.maf_row5 ]
        ...
        expected_output = {
            'output_file': {
                ...
                'basename': 'output.maf',
                'class': 'File',
                'checksum': 'sha1$de3f553b81bd7688e3b849a186419b60cfb76ae0',
                'size': 649,
