...
class TestSamplesFilloutIndex(PlutoTestCase):
    ...
    def setUp(self):
        ...
        rows3 = [ self.maf_row5, self.maf_row6 ]
    ...
    def test_run_fillout_workflow(self):
        ...
        self.input = {
            ...
            "unindexed_sample_ids": ["Sample1", "Sample2"],
            "unindexed_bam_files": [
        ...
        expected_output = {
            'output_file': {
                ...
                'basename': 'output.maf',
                'class': 'File',
                'checksum': 'sha1$ee93cb3dd2c4311ce8d1372ab120777b5c128374',
                'size': 10414,
