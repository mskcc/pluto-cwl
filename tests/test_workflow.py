                ...
                'analysis_dir': {
                    ...
                    'portal_dir': {
                        ...
                        'listing': [
                            ...
                            {
                                'location': 'file://' + os.path.join(output_dir, 'portal/data_CNA.scna.txt'),
                                'basename': 'data_CNA.scna.txt',
                                'class': 'File',
                                'checksum': 'sha1$8bec923ab1d622b4cf38ae042ac2416725650aed',
                                'size': 5463,
                                'path': os.path.join(output_dir, 'portal/data_CNA.scna.txt')
                            },
                            {
                            ...
                            },
                            {
                                'class': 'Directory',
                                'basename': 'case_list',
                                'location': 'file://' + os.path.join(output_dir, 'portal/case_list'),
                                'path': os.path.join(output_dir, 'portal/case_list'),
                                'listing': [
                                    {'location': 'file://' + os.path.join(output_dir, 'portal/case_list/cases_all.txt'),
                                    'basename': 'cases_all.txt',
                                    'class': 'File',
                                    'checksum': 'sha1$b9e43289cec5603b0886b5e8507c8d019387c125',
                                    'size': 616,
                                    'path': os.path.join(output_dir, 'portal/case_list/cases_all.txt')},
                                    {'location': 'file://' + os.path.join(output_dir, 'portal/case_list/cases_cnaseq.txt'),
                                    'basename': 'cases_cnaseq.txt',
                                    'class': 'File',
                                    'checksum': 'sha1$b87e2da8dce0fddbadec348efe2986519b2a794b',
                                    'size': 696,
                                    'path': os.path.join(output_dir, 'portal/case_list/cases_cnaseq.txt')},
                                    {'location': 'file://' + os.path.join(output_dir, 'portal/case_list/cases_cna.txt'),
                                    'basename': 'cases_cna.txt',
                                    'class': 'File',
                                    'checksum': 'sha1$053481a8299e9430117f8e45e081aa7ec21033a6',
                                    'size': 628,
                                    'path': os.path.join(output_dir, 'portal/case_list/cases_cna.txt')},
                                    {'location': 'file://' + os.path.join(output_dir, 'portal/case_list/cases_sequenced.txt'),
                                    'basename': 'cases_sequenced.txt',
                                    'class': 'File',
                                    'checksum': 'sha1$ef9f5aef03c2527bf576470168660557ca1c7cc9',
                                    'size': 641,
                                    'path': os.path.join(output_dir, 'portal/case_list/cases_sequenced.txt')}
                                ]
                            }
                        ]
                    }
            ...
            expected_output = {
                ...
                'portal_dir': {
                    ...
                    'listing': [
                        ...
                        'basename': 'data_CNA.scna.txt',
                        'class': 'File',
                        'checksum': 'sha1$a671bc503e91c9b34848244e268792903e2faad3',
                        'size': 6882,
                        'path': os.path.join(output_dir, 'portal/data_CNA.scna.txt')},
                        {'location': 'file://' + os.path.join(output_dir, 'portal/data_mutations_extended.txt'),
                        'basename': 'data_mutations_extended.txt',
                        ...
                        {'class': 'Directory',
                        'basename': 'case_list',
                        'listing': [{'location': 'file://' + os.path.join(output_dir, 'portal/case_list/cases_all.txt'),
                        'basename': 'cases_all.txt',
                        'class': 'File',
                        'checksum': 'sha1$b9e43289cec5603b0886b5e8507c8d019387c125',
                        'size': 616,
